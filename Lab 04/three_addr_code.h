...
public:
    ...
    void generate() {
        // 1. Write a header to the output file explaining the format of the
        // three-address code that follows
        ...
        // 2. Walk the AST starting from the program root and let every node
        ast_root->generate_code(outcode, symbol_to_temp, temp_count, label_count);

        // 3. Write a footer marking the end of the generated code
        outcode << endl;
