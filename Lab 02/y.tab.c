...
{
       0,    62,    62,    72,    79,    88,    95,   105,   104,   147,
     146,   176,   186,   196,   207,   221,   220,   247,   246,   271,
     299,   307,   315,   323,   333,   347,   361,   376,   394,   401,
     410,   417,   424,   431,   438,   445,   452,   459,   466,   473,
     482,   489,   498,   506,   515,   522,   531,   538,   547,   554,
     563,   571,   580,   588,   598,   605,   612,   620,   626,   633,
     669,   676,   683,   690,   697,   706,   714,   722,   729
};
#endif
...
#line 634 "24341140+24341217.y"
    {
		...
		if (func_sym != NULL && func_sym->get_symbol_class() == "function")
		{
			...
			string arg_str = (yyvsp[(3) - (4)])->getname();
			int num_args = 0;
			if (!arg_str.empty())
			{
				num_args = 1;
