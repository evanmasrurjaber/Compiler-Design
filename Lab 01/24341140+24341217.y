...
%token FOR WHILE INT FLOAT VOID CHAR RETURN PRINTLN ID CONST_INT CONST_FLOAT ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD SEMICOLON COMMA
...
start : program
	{
		outlog<<"At line no: "<<line_num<<" start : program "<<endl<<endl<<endl;
	}
	;
